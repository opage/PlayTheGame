...
public class accessoryManaged {
	...
	private Accessory selectedGame= new Accessory();
	...
	private List<Accessory> consoles;
	private String nameGame = "";
	private long idPlatform = -1;
	
	
	public accessoryManaged() {
		Connecction();
	}
	...
	public List<Accessory> getConsoles() {
		consoles = (List<Accessory>) admin.getAccessoryByCriteria(nameGame, idPlatform);
		return consoles;
	}
	 ...
	 */
	public void setSelectedGame(Accessory selectedGame) {
	 ...
	 */
	public Accessory getSelectedGame() {
		return (Accessory) dataTable.getRowData();
	}
