...
public class ListAccessory
{
	...
	public  ListAccessory()
	{   
	Connecction();
	listproducts= searchEngine.getAllAccessorys();
	}
	...
	{   
		...
		listproducts= searchEngine.getAccessorysByCriterias((String)inputTextKeyword.getValue(),idPlatform,paramPrice);
		keyWords="";
		return "";
	}
