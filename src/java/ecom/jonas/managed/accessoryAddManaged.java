...
public class accessoryAddManaged {
	@EJB
	...
	private Accessory gameAdd = new Accessory();
	public accessoryAddManaged() {
		Connecction();
	 ...
	 *            the gameAdd to set
	 */
	public void setGameAdd(Accessory gameAdd) {
