...
public class ListGame
{
	...
	{   
	Connecction();
	listproducts= searchEngine.getAllGames();
	}
	...
	{   
		...
		System.out.println("params="+paramPlatform+" "+paramType+" "+paramPriceProduct);
		...
		listproducts= searchEngine.getGamesByCriterias((String)inputTextKeyword.getValue(),idPlatform,idType,paramPrice);
		keyWords="";
		return "";
	}
