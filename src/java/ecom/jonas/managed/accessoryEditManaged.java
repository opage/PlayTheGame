...
public class accessoryEditManaged {
	@EJB
	...
	String idGame=null;
	private Accessory gameEdit = new Accessory();
	public accessoryEditManaged() {
	...
	public String  DoEdit() {
         ...
         if(idGame!=null){
 			gameEdit= admin.getAccessoryById(Integer.parseInt(idGame));
	 ...
	 *            the gameEdit to set
	 */
	public void setGameEdit(Accessory gameEdit) {
	...
	public String EditGame() {
		...
		admin.updateAccessory(gameEdit);
		
		return "toAdminAccessory";
	}
