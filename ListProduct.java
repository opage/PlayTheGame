...
public class ListProduct
{
	...
	{   
		...
		String tProduct=FacesContext.getCurrentInstance().getExternalContext().getRequestParameterMap().get("TypeProduct");
		...
		if(!(tProduct.equals("")||tProduct.equals(null))){
			typeProduct = tProduct;
		}
		listproducts= searchEngine.getProductsByCriterias((String)inputTextKeyword.getValue(),idPlatform,typeProduct);
		return "";
